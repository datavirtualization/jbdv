...
/**
 * Used to discover the ModeShape repository custom binary storage components.
 */
public class CustomBinaryStorageDiscoveryComponent extends ModeShapeStorageDiscoveryComponent<CustomBinaryStorageComponent> {
    ...
    /**
     * Constructs a custom binary storage discovery component.
     */
    public CustomBinaryStorageDiscoveryComponent() {
        super(CustomBinaryStorageComponent.TYPE, StorageType.BINARY);
    }
