...
/**
 * Used to discover the ModeShape repository database binary storage components.
 */
public class DbBinaryStorageDiscoveryComponent extends ModeShapeStorageDiscoveryComponent<DbBinaryStorageComponent> {

    /**
     * Constructs a database binary storage discovery component.
     */
    public DbBinaryStorageDiscoveryComponent() {
        super(DbBinaryStorageComponent.TYPE, StorageType.BINARY);
    }
