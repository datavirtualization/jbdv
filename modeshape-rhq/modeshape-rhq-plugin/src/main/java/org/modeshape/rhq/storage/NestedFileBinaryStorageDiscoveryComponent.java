...
/**
 * Used to discover the ModeShape repository nested file binary storage components.
 */
public class NestedFileBinaryStorageDiscoveryComponent
    extends ModeShapeStorageDiscoveryComponent<NestedFileBinaryStorageComponent> {

    /**
     * Constructs a nested file binary storage discovery component.
     */
    public NestedFileBinaryStorageDiscoveryComponent() {
        super(NestedFileBinaryStorageComponent.TYPE, StorageType.BINARY);
    }
    ...
    protected org.rhq.modules.plugins.jbossas7.json.Operation operation( final Address address ) {
        return Operation.Util.createRhqOperation(CompositeBinaryStorageComponent.createGetNestedFileBinaryStorages(), address);
    }
