...
/**
 * Used to discover the ModeShape repository nested cache binary storage components.
 */
public class NestedCacheBinaryStorageDiscoveryComponent
    extends ModeShapeStorageDiscoveryComponent<NestedCacheBinaryStorageComponent> {

    /**
     * Constructs a nested cache binary storage discovery component.
     */
    public NestedCacheBinaryStorageDiscoveryComponent() {
        super(NestedCacheBinaryStorageComponent.TYPE, StorageType.BINARY);
    }
